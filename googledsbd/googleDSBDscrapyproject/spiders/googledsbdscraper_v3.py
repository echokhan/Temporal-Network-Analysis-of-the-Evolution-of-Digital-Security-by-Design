...
class GoogledsbdscraperSpider_v3(scrapy.Spider):
    name = "googledsbdscraper_v3"
    allowed_domains = ["www.google.com", "google.com"]
    start_urls = ["https://www.google.com"]
    #search_keyword = "\"digital security by design\""
    #search_keyword = "\"dsbd\""
    domain_list = ['.uk', '.eu', '.com']
    ...
    search_keyword_list = ['\"digital security by design\"', '\"dsbd\"']
    ...
    custom_settings = {
        ...
        #'LOG_FILE': f'./scrapinglog/{name}.log'
    }
    ...
    def _get_google_url(self):
        ...
        for domain in self.domain_list:
            print(f"Working on domain {domain}")
